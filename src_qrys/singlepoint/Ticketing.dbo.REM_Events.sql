select
	 ...
	 [AlertDescription] = concat(char(34), isNull(replace(cast([REM_Events].[AlertDescription] as nvarchar(-1)), char(34), char(0)), '\N'), char(34)),
	 [AlertInputData] = concat(char(34), isNull(replace(cast([REM_Events].[AlertInputData] as nvarchar(-1)), char(34), char(0)), '\N'), char(34)),
